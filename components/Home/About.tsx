        ...
        <SlideUpWhenVisible threshold={undefined}>
          ...
          >
            ...
            <Text fontSize={{ base: "14px", md: "16px" }} whiteSpace="pre-line">
              Hi! I&apos;m tygerxqt, I&apos;ve been close to a computer since an
              ...
              />
              I&apos;m interested in building something helpful and automate
              ...
              <br />
              <br />
              When I&apos;m not working on projects, I play video games, watch
              some anime, or if the weather&apos;s good, I go out on a bike ride
              with my friends!
            </Text>
          </Stack>
        </SlideUpWhenVisible>
